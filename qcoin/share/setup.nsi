...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER PLM
!define MUI_FINISHPAGE_RUN $INSTDIR\PLM.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Uninstall PLM.lnk" $INSTDIR\uninstall.exe
