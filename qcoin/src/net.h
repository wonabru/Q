...
CNode* ConnectNodeToCheck(CAddress addrConnect, const char *strDest = NULL);
...
public:
    ...
    CNode(SOCKET hSocketIn, CAddress addrIn, std::string addrNameIn = "", bool fInboundIn=true) : ssSend(SER_NETWORK, MIN_PROTO_VERSION)
    {
        nServices = 0;
        hSocket = hSocketIn;
