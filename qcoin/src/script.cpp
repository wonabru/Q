...
bool IsCanonicalSignature(const valtype &vchSig) {
    // See https://qcointalk.org/index.php?topic=8392.msg127623#msg127623
...
uint256 SignatureHash(CScript scriptCode, const CTransaction& txTo, unsigned int nIn, int nHashType)
{
    ...
    {
        logPrint("ERROR: SignatureHash() : nIn=%d out of range\n", nIn);
        return 1;
    }
    ...
    else if ((nHashType & 0x1f) == SIGHASH_SINGLE)
    {
        ...
        {
            logPrint("ERROR: SignatureHash() : nOut=%d out of range\n", nOut);
            return 1;
        }
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // Mark address tx, sender provides hash of pubkey, receiver provides signature and pubkey
