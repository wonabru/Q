...
/** Utility functions used by the Mark Qt UI.
 */
namespace GUIUtil
{
    ...
    // Render Mark addresses in monospace font
    ...
    // See Mark URI definition discussion here: https://qcointalk.org/index.php?topic=33490.0
    ...
    */
    ...
    /** Help message for PLM, shown with --help. */
