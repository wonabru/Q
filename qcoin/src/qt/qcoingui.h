...
/**
  Mark GUI main class. This class represents the main window of the Mark UI. It communicates with both the client and
...
public:
    ...
    explicit QcoinGUI(QWidget *parent = 0);
    ~QcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a qcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
