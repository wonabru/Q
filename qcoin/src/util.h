...
std::string hash2name(uint256 hash);
std::vector<unsigned char> DecodeBase64(const char* p, bool* pfInvalid = NULL);
std::string DecodeBase64(const std::string& str);
std::string EncodeBase64(const unsigned char* pch, size_t len);
std::string EncodeBase64(const std::string& str);
std::vector<unsigned char> DecodeBaseMM(const char* p, bool* pfInvalid = NULL);
std::string DecodeBaseMM(const std::string& str);
std::string EncodeBaseMM(const unsigned char* pch, size_t len);
std::string EncodeBaseMM(const std::string& str);
