...
public:
    ...
    void setupUi(QDialog *EditAddressDialog)
    {
        ...
        DoNotRegisterChb = new QCheckBox(EditAddressDialog);
        DoNotRegisterChb->setObjectName(QString::fromUtf8("DoNotRegisterChb"));

        verticalLayout->addWidget(DoNotRegisterChb);
...
#endif // QT_NO_TOOLTIP
        DoNotRegisterChb->setText(QApplication::translate("EditAddressDialog", "Do Not Register Name", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
